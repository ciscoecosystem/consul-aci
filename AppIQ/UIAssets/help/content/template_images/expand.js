                                ...
                                bParamExpanded)
{
  ...
  {
    document.write("<a href=\"javascript:XMART_ToggleDIV('" + ParamID + "');\">");
  }
}
                                 ...
                                 bParamExpanded)
{
      ...
      (typeof(document.getElementById) != "undefined"))
  {
    if (bParamExpanded)
    {
      VarIMGSrc = "template_images/expanded.gif";
    }
    else
    {
      VarIMGSrc = "template_images/collapse.gif";
    }
...
function  XMART_ToggleDIV(ParamID)
{
  var  VarImageID;
  var  VarIMG;
  var  VarDIV;
  ...
  if (typeof(document.all) != "undefined")
  {
        ...
        (VarDIV != null))
    {
      if (VarDIV.style.display == "block")
      {
        if (VarIMG != null)
        {
          VarIMG.src = "template_images/collapse.gif";
        }
      ...
      else
      {
        if (VarIMG != null)
        {
          VarIMG.src = "template_images/expanded.gif";
        }
