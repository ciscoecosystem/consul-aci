        ...
        return (
            <React.Fragment>
                ...
                <div className="overview">
                    ...
                    <div className="header-text"><b>Overview</b></div>
                    ...
                    {this.state.loadingDashBoard ? <Loader></Loader> :
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="row">
                                    <div className="agent" >
                                        <div><span className="green-dot"></span><span>Connected({this.state.agents ? this.nFormatter(this.state.agents.up) : 0})</span></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div className="agent" >
                                        <div><span className="red-dot"></span><span>Disconnected({this.state.agents ? this.nFormatter(this.state.agents.down) : 0})</span></div>
                                    </div>
                                </div>
                            </div>
                            {this.state.services ?
