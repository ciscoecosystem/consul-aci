...
FETCH_EPG_DATA_URL = '{0}?query-target-filter=wcard(fvCEp.dn,"tn-{1}/")&query-target=children&target-subtree-class=fvCEp&rsp-subtree=children&rsp-subtree-class=fvRsToVm,fvRsCEpToPathEp,fvIp'
